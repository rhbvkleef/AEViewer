...
sudo -E apt-get -q -y install apache2 php5.6 libapache2-mod-php5.6 mysql-server-5.5 php5.6-mcrypt php5.6-cli php5.6-common php5.6-mysql php5.6-sqlite php5.6-mbstring php5.6-xml php5.6-zip
